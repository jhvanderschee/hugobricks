...
*Note that the template Hugobricks is based on the MIT licensed [Hugoplate](https://hugoplate.netlify.app) from Zeon studio. Hugoplate scores 20 points lower on Performance in Google Lighthouse (not 99, but around 80). This article explains why.*