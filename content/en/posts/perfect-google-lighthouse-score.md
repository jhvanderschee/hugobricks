...
*Note that the template Hugobricks is based on the MIT licensed [Hugoplate](https://hugoplate.netlify.app) from Zeon studio. Hugoplate scores 20 points lower on Performance in Google Lighthouse, due to the 'blocking code issue'. This article explains why.*