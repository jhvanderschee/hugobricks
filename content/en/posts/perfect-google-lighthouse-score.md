...
**Note that the template Hugobricks is based on the MIT licensed Hugoplate from Zeon studio that scores a 20 points lower (not 99, but around 80) in Google Lighthouse. This article explains why.*